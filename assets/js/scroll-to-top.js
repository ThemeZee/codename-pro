 ...
 */
 ...
 ( function() {
	...
	document.addEventListener( 'DOMContentLoaded', function() {
		...
		scrollButton.setAttribute( 'aria-label', harrisonProScrollToTop.label );
		scrollButton.classList.add( 'scroll-to-top-button' );

		// Add icon to Scroll to Top button.
		var icon = new DOMParser().parseFromString( harrisonProScrollToTop.icon, 'text/html' ).body.firstElementChild;
