...
( function( $ ) {
	...
	wp.customize( 'harrison_theme_options[tertiary_color]', function( value ) {
		value.bind( function( newval ) {
	...
	function loadCustomFont( font, type ) {
		...
		var fontStylesheet = "<link id='harrison-pro-custom-" + type + "' href='" + fontFileURL + "' rel='stylesheet' type='text/css'>";
		var checkLink = $( "head" ).find( "#harrison-pro-custom-" + type ).length;

		if (checkLink > 0) {
			$( "head" ).find( "#harrison-pro-custom-" + type ).remove();
		}
