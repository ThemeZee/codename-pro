...
( function( $ ) {
	...
	/* Header textfield. */
	wp.customize( 'codename_theme_options[header_text]', function( value ) {
	...
	wp.customize( 'codename_theme_options[header_date]', function( value ) {
	...
	wp.customize( 'codename_theme_options[navi_submenu_color]', function( value ) {
		value.bind( function( newval ) {
			var text_color, text_hover_color, border_color;
	...
	wp.customize( 'codename_theme_options[widget_title_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'codename_theme_options[text_font]', function( value ) {
		value.bind( function( newval ) {
			...
			var googleFontSource = "<link id='codename-pro-custom-text-font' href='" + googleFontPath + "' rel='stylesheet' type='text/css'>";
			var checkLink = $( "head" ).find( "#codename-pro-custom-text-font" ).length;

			if (checkLink > 0) {
				$( "head" ).find( "#codename-pro-custom-text-font" ).remove();
			}
	...
	wp.customize( 'codename_theme_options[title_font]', function( value ) {
		value.bind( function( newval ) {
			...
			var fontFamilyUrl = newval.split( " " ).join( "+" );
			var googleFontPath = "https://fonts.googleapis.com/css?family=" + fontFamilyUrl + ":400,700";
			var googleFontSource = "<link id='codename-pro-custom-title-font' href='" + googleFontPath + "' rel='stylesheet' type='text/css'>";
			var checkLink = $( "head" ).find( "#codename-pro-custom-title-font" ).length;

			if (checkLink > 0) {
				$( "head" ).find( "#codename-pro-custom-title-font" ).remove();
			}
			$( "head" ).append( googleFontSource );
	...
	wp.customize( 'codename_theme_options[navi_font]', function( value ) {
		value.bind( function( newval ) {
			...
			var fontFamilyUrl = newval.split( " " ).join( "+" );
			var googleFontPath = "https://fonts.googleapis.com/css?family=" + fontFamilyUrl + ":400,700";
			var googleFontSource = "<link id='codename-pro-custom-navi-font' href='" + googleFontPath + "' rel='stylesheet' type='text/css'>";
			var checkLink = $( "head" ).find( "#codename-pro-custom-navi-font" ).length;

			if (checkLink > 0) {
				$( "head" ).find( "#codename-pro-custom-navi-font" ).remove();
			}
			$( "head" ).append( googleFontSource );
