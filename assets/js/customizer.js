...
( function( $ ) {
	...
	wp.customize( 'harrison_theme_options[header_search]', function( value ) {
	...
	/* Author Bio checkbox */
	wp.customize( 'harrison_theme_options[author_bio]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'harrison_theme_options[primary_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'harrison_theme_options[secondary_color]', function( value ) {
		value.bind( function( newval ) {
	...
	/* Accent Color Option */
	wp.customize( 'harrison_theme_options[accent_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'harrison_theme_options[highlight_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'harrison_theme_options[light_gray_color]', function( value ) {
		value.bind( function( newval ) {
	...
	/* Gray Color Option */
	wp.customize( 'harrison_theme_options[gray_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'harrison_theme_options[dark_gray_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'harrison_theme_options[page_color]', function( value ) {
		value.bind( function( newval ) {
	...
	/* Header Color Option */
	wp.customize( 'harrison_theme_options[header_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'harrison_theme_options[navi_color]', function( value ) {
		value.bind( function( newval ) {
	...
	/* Link Color Option */
	wp.customize( 'harrison_theme_options[link_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'harrison_theme_options[link_hover_color]', function( value ) {
		value.bind( function( newval ) {
	...
	/* Button Color Option */
	wp.customize( 'harrison_theme_options[button_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'harrison_theme_options[button_hover_color]', function( value ) {
		value.bind( function( newval ) {
	...
	/* Title Color Option */
	wp.customize( 'harrison_theme_options[title_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'harrison_theme_options[title_hover_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'harrison_theme_options[footer_widgets_color]', function( value ) {
		value.bind( function( newval ) {
	...
	/* Footer Color Option */
	wp.customize( 'harrison_theme_options[footer_color]', function( value ) {
		value.bind( function( newval ) {
			var text_color, link_color, link_hover_color, border_color;
	...
	/* Theme Fonts */
	wp.customize( 'harrison_theme_options[text_font]', function( value ) {
		value.bind( function( newval ) {

			// Embed Font.
			var fontFamilyUrl = newval.split( " " ).join( "+" );
			var googleFontPath = "https://fonts.googleapis.com/css?family=" + fontFamilyUrl + ":400,700";
			var googleFontSource = "<link id='harrison-pro-custom-text-font' href='" + googleFontPath + "' rel='stylesheet' type='text/css'>";
			var checkLink = $( "head" ).find( "#harrison-pro-custom-text-font" ).length;

			if (checkLink > 0) {
				$( "head" ).find( "#harrison-pro-custom-text-font" ).remove();
			}
	...
	wp.customize( 'harrison_theme_options[title_font]', function( value ) {
		value.bind( function( newval ) {

			// Embed Font.
			var fontFamilyUrl = newval.split( " " ).join( "+" );
			var googleFontPath = "https://fonts.googleapis.com/css?family=" + fontFamilyUrl + ":400,700";
			var googleFontSource = "<link id='harrison-pro-custom-title-font' href='" + googleFontPath + "' rel='stylesheet' type='text/css'>";
			var checkLink = $( "head" ).find( "#harrison-pro-custom-title-font" ).length;

			if (checkLink > 0) {
				$( "head" ).find( "#harrison-pro-custom-title-font" ).remove();
			}
			$( "head" ).append( googleFontSource );
	...
	/* Title Font Weight */
	wp.customize( 'harrison_theme_options[title_is_bold]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'harrison_theme_options[title_is_uppercase]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'harrison_theme_options[navi_font]', function( value ) {
		value.bind( function( newval ) {

			// Embed Font.
			var fontFamilyUrl = newval.split( " " ).join( "+" );
			var googleFontPath = "https://fonts.googleapis.com/css?family=" + fontFamilyUrl + ":400,700";
			var googleFontSource = "<link id='harrison-pro-custom-navi-font' href='" + googleFontPath + "' rel='stylesheet' type='text/css'>";
			var checkLink = $( "head" ).find( "#harrison-pro-custom-navi-font" ).length;

			if (checkLink > 0) {
				$( "head" ).find( "#harrison-pro-custom-navi-font" ).remove();
			}
			$( "head" ).append( googleFontSource );
	...
	/* Navi Font Weight */
	wp.customize( 'harrison_theme_options[navi_is_bold]', function( value ) {
		value.bind( function( newval ) {
			var fontWeight = newval ? 'bold' : 'normal';
	...
	/* Navi Text Transform */
	wp.customize( 'harrison_theme_options[navi_is_uppercase]', function( value ) {
		value.bind( function( newval ) {
			var textTransform = newval ? 'uppercase' : 'none';
