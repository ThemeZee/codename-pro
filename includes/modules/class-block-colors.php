...
class Harrison_Pro_Block_Colors {
	...
	static function color_settings( $wp_customize ) {
		...
		$wp_customize->add_setting( 'harrison_theme_options[tertiary_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'harrison_theme_options[tertiary_color]', array(
				'label'    => esc_html_x( 'Tertiary', 'Color Option', 'harrison-pro' ),
				'section'  => 'harrison_pro_section_block_colors',
				'settings' => 'harrison_theme_options[tertiary_color]',
				'priority' => 30,
			)
		) );
