 ...
 * Footer Line Class
 */
class Codename_Pro_Footer_Line {
	...
	static function setup() {
		...
		add_action( 'codename_footer_text', array( __CLASS__, 'footer_text' ) );

		// Hide Credit Link.
		add_filter( 'codename_hide_elements', array( __CLASS__, 'hide_credit_link' ), 20 );
	...
	static function footer_settings( $wp_customize ) {
		...
		$wp_customize->add_section( 'codename_pro_section_footer', array(
			'title'    => esc_html__( 'Footer Settings', 'codename-pro' ),
			'priority' => 90,
		...
		$wp_customize->add_control( 'codename_theme_options[footer_text]', array(
			'label'    => esc_html__( 'Footer Text', 'codename-pro' ),
		...
		$wp_customize->add_control( 'codename_theme_options[credit_link]', array(
			'label'    => esc_html__( 'Display Credit Link to ThemeZee on footer line', 'codename-pro' ),
			'section'  => 'codename_pro_section_footer',
...
// Run Class.
add_action( 'init', array( 'Codename_Pro_Footer_Line', 'setup' ) );

// Register footer navigation in backend.
add_action( 'after_setup_theme', array( 'Codename_Pro_Footer_Line', 'register_footer_menu' ), 30 );
