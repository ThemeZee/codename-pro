...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class Codename_Pro_Customize_Font_Control extends WP_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'codename_pro_custom_font';
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'codename-pro' ),
				'next'     => esc_html__( 'Next Font', 'codename-pro' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'codename-pro' ),
			);
